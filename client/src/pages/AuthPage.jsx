    ...
    <Background>
      <div className="flex-1 w-full flex items-center justify-center">
        ...
        >
          ...
          <motion.div layout="position" className="mt-6 flex items-center justify-between">
            <span className="w-1/5 border-b border-slate-200 dark:border-white/10 lg:w-1/4"></span>
            <span className="text-xs text-center text-slate-500 dark:text-neutral-400 uppercase tracking-widest font-bold">or continue with</span>
            <span className="w-1/5 border-b border-slate-200 dark:border-white/10 lg:w-1/4"></span>
          </motion.div>

          <motion.div layout="position" className="mt-6 flex flex-col space-y-3">
            <a 
              href={`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/api/v1/users/auth/google`}
              className="w-full bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-white font-sans font-semibold text-base py-3 rounded-full flex items-center justify-center space-x-2 hover:bg-slate-50 dark:hover:bg-white/10 transition-all duration-300"
            >
            ...
            <a 
              href={`${import.meta.env.VITE_API_URL || 'http://localhost:8000'}/api/v1/users/auth/github`}
              className="w-full bg-[#24292F] text-white font-sans font-semibold text-base py-3 rounded-full flex items-center justify-center space-x-2 hover:bg-[#24292F]/90 transition-all duration-300"
            >
